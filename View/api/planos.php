...
try {
    if (isset($_GET['meus']) && $_GET['meus'] == '1') {
        ...
        $sql = "SELECT pt.idPlano, p.idPortifolio, t.idTreino AS idTreino, t.nome AS nome, p.descricao AS descricao, p.metodologia AS metodologia, p.dificuldade AS dificuldade, e.id_empresa, e.nomeFantasia, e.telefone, e.email
                FROM PlanoTreino pt
